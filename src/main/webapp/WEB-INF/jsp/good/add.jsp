...
<div id=MainArea>
    <s:form action="userAction_add.action">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:select list="#departmentList" listKey="did" listValue="dname" headerKey=""
                                      headerValue="请选择部门" name="did" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>用户名</td>
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 -->
            <div class="ItemBlock_Title1">
                <img border="0" width="4" height="7"
                     src="${pageContext.request.contextPath}/css/blue/images/item_point.gif"/> 岗位设置
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:select list="#postList" name="pids" listKey="pid" listValue="pname"
